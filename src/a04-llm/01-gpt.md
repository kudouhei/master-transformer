...
- GPT (which stands for generative pretrained transformer)
- Transformer blocks are a key component of gpt-like models.
- The transformer block is a stack of two layers:
